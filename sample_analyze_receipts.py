...
def analyze_receipts():
    ...
    endpoint = os.environ"https://mor-aidocscan.cognitiveservices.azure.com/"
    key = os.environ"5U2TkOOLmRqID6iD5ViIUgzMS7QzDmQULn11SibwjvGvTKai7ObqJQQJ99ALACYeBjFXJ3w3AAALACOGNxf5"
